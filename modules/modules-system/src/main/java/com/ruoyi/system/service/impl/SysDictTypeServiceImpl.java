...
public class SysDictTypeServiceImpl extends ServiceImpl<SysDictTypeMapper, SysDictType> implements ISysDictTypeService
{
    ...
    {
        List<SysDictType> beList = baseMapper.selectAllByTenantId(tenantId);
        //删除所有当前租户配置
        SysDictType sysConfig = new SysDictType();
        sysConfig.setTenantId(byTenantId);
        baseMapper.delete(new QueryWrapper<>(sysConfig));
        //插入所有配置
        beList.forEach(c->c.setTenantId(byTenantId));
        saveBatch(beList);
        List<SysDictType> byList = baseMapper.selectAllByTenantId(byTenantId);
